        ...
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.socials}>
              <a href="https://www.instagram.com/adish.the.barber" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="https://www.facebook.com/share/1BMN4dJ82L/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Facebook">
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.contactList}>
              ...
              <li>
                ...
                <a href="mailto:splittend2018@gmail.com" className={styles.contactLink}>
                  splittend2018@gmail.com
                </a>
              </li>
              <li>
